...
function loadGame(game) {
    ...
    const gameDetails = {
        ...
        BUBBLES: {
            title: "Bubbles",
            description: "Pop the bubbles as they appear on the screen! Try to pop as many as you can before time runs out.",
            screenshot: "screenshots/bubblesSs.png",
            link: "JsGames/JsGames/BUBBLES.html"
        },
        GAUNTLET: {
            title: "Gauntlet Master",
            description: "Navigate through dungeons, fight monsters, and collect treasures in this classic-style RPG game.",
            screenshot: "screenshots/gauntletSs.png",
            link: "JsGames/JsGames/javascript-gauntlet-master/javascript-gauntlet-master/index.html"
        }
    };
